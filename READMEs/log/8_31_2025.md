...
- ie: `gcloud pubsub topics create qna-ingest-topic`
...
### Need to allow service account to read secrets from Google Secret Manage

```sh
gcloud projects add-iam-policy-binding 830723611668 \
       --member="serviceAccount:kalygo3-kb-ingest-sa@kalygo-436411.iam.gserviceaccount.com" \
       --role="roles/secretmanager.secretAccessor"
```

## Adding some more environment variables

- `echo -n "production" | gcloud secrets create ENVIRONMENT --data-file=-`
- `gcloud secrets delete KB_INGEST_SA`
- `gcloud secrets create KB_INGEST_SA --data-file="kalygo3-kb-ingest-sa-key.json"`
